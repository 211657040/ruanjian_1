...
<div class="main">
    ...
    <form action="_postReg.php" method="post" onsubmit="return check()">
        <table align="center" border="1" style="border-collapse: collapse" cellpadding="10" cellspacing="0">
            ...
            <tr>
                ...
                <td align="left">
                    <input type="checkbox" name="fav[]" value="打电动"><span class="yanse0">一次元</span>
                    <input type="checkbox" name="fav[]" value="缘神启动"><span class="yanse0">二次元</span>
                    <input type="checkbox" name="fav[]" value="我潮!原"><span class="yanse0">三次元</span>
                </td>
            </tr>
            <tr>
